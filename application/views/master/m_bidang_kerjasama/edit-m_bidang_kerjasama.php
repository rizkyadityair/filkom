  ...
  <!-- Content Wrapper. Contains page content -->
    <form method="POST" action="<?= base_url('master/M_bidang_kerjasama/update') ?>" id="upload-create" enctype="multipart/form-data">
      <input type="hidden" name="mbk_id" value="<?= $m_bidang_kerjasama['mbk_id'] ?>">
      <div class="show_error"></div>

      <div class="form-group">
        <label for="form-mbk_name">Name</label>
        <input type="text" class="form-control" id="form-mbk_name" placeholder="Masukan Name" name="dt[mbk_name]" value="<?= $m_bidang_kerjasama['mbk_name'] ?>">
      </div>
