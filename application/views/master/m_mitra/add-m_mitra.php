  ...
  <form method="POST" action="<?= base_url('master/M_mitra/store') ?>" id="upload-create" enctype="multipart/form-data">
    <div class="show_error"></div>
      <div class="form-group">
          <label for="form-m_name">Nama</label>
          <input type="text" class="form-control" id="form-m_name" placeholder="Masukan Nama" name="dt[m_name]">
      </div>

      <div class="form-group">
          <label for="form-m_alamat">Alamat</label>
          <input type="text" class="form-control" id="form-m_alamat" placeholder="Masukan Alamat" name="dt[m_alamat]">
      </div>

      <div class="form-group">
          <label for="form-m_cp_name">PIC / Nama Contact Person</label>
          <input type="text" class="form-control" id="form-m_cp_name" placeholder="Masukan PIC / Nama Contact Person" name="dt[m_cp_name]">
      </div>

      <div class="form-group">
          <label for="form-m_telp">Telp</label>
          <input type="text" class="form-control" id="form-m_telp" placeholder="Masukan Telp" name="dt[m_telp]">
      </div>
