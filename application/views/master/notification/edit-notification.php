...
<div class="content-wrapper">
  ...
  <section class="content">
    <form method="POST" action="<?= base_url('master/Notification/update') ?>" id="upload-create" enctype="multipart/form-data">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="form-counting" placeholder="Masukan Counting" name="dt[counting]" value="<?= $notification['counting'] ?>">
              </div>
              <div class="form-group">
                ...
                <select name="dt[slug]" class="form-control select2">
                  ...
                  <?php
                    ...
                    foreach ($menu_master as $menu_master_record) {
                      $text="";
                      if($menu_master_record['notif']==$notification['slug']){
                        $text = "selected";
                      }
                      echo "<option value=".$menu_master_record['notif']." ".$text." >".$menu_master_record['notif'].' - '.$menu_master_record['name']."</option>";
                    }
                  ?>
                </select>
              </div>
                ...
                <select name="dt[user_id]" class="form-control select2">
                  ...
                  <?php
                    ...
                    foreach ($user as $user_record) {
                      $text="";
                      if($user_record['id']==$notification['user_id']){
                        $text = "selected";
                      }
                ...
                <select name="dt[role_id]" class="form-control select2">
                  ...
                  <?php
                    ...
                    foreach ($role as $role_record) {
                      $text="";
                      if($role_record['id']==$notification['role_id']){
                        $text = "selected";
                      }
