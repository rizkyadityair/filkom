...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?= base_url() ?>" class="logo" style="background-color: #071C4D;">
    ...
    <nav class="navbar navbar-static-top" style="background: #071C4D;">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <?php
              $dir = $this->mymodel->selectDataone('file',['table_id'=>$this->session->userdata('id'),'table'=>'user']);
            ?>
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img class="user-image" src="<?= base_url($dir['dir'])?>" onerror="this.onerror=null;this.src='<?= base_url('assets/images')?>/user.png';" />
              <span class="hidden-xs"><?= $this->session->userdata('name');?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header" style="background: #071c4d">
                <img style="width: 100px;height: 100px;" src="<?= base_url($dir['dir'])?>" onerror="this.onerror=null;this.src='<?= base_url('assets/images')?>/user.png';" />
                <p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        foreach ($menu as $m) {
          ...
          <?php } elseif ($m['type']=='label') { ?>
            <li class="header" style="background: #071c4d"><?= ($m['icon'])?'<i class="'.$m['icon'].'"></i> ':'' ?><?= $m['name'] ?></li>
          <?php } ?>
        <?php } ?>
