              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="pull-right">
                    <!-- <a href="<?= base_url('fitur/ekspor/kerja_sama') ?>" target="_blank">
                      <button type="button" class="btn btn-sm btn-warning"><i class="fa fa-file-excel-o"></i> Ekspor Kerja Sama</button> 
                    </a>
                    <button type="button" class="btn btn-sm btn-info" onclick="$('#modal-impor').modal()"><i class="fa fa-file-excel-o"></i> Import Kerja Sama</button> -->
                  </div>
                </div>  
              </div>
            </div>
  ...
  <script type="text/javascript">
    ...
    function loadtable(status) {
      ...
      function getstatus(id,e) {
        ...
        //     keyboard: false
        // });
        // $('#wrapper-modal-status').html('<center><i class="fa fa-spin fa-spinner"></i> Loading...</center>');
        // $('#wrapper-modal-status').load('<?= base_url('master/kerja_sama/getstatus/')?>'+id);
        location.href = '<?= base_url('master/kerja_sama/getstatus/')?>'+id;
      }
